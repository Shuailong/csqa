...
class PretrainedBertEmbedder(BertEmbedder):
    ...
    def __init__(self,
        ...
        super().__init__(bert_model=model, top_layer_only=top_layer_only, pool=pool)
