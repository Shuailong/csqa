...
# @Date: 2019-05-21 22:14:36
# @Last Modified by: Shuailong
# @Last Modified time: 2019-05-21 22:14:46
...
@DatasetReader.register("csqa-question-evidence")
class CSQAReaderQuestionEvidence(DatasetReader):
    """
    ...
    def text_to_instance(self,  # type: ignore
        ...
        for c_tokens in choice_tokens:
            qa_pair = question_tokens + [Token("[SEP]")] + evidence_tokens_flat + \
                [Token("[SEP]")] + c_tokens
