...
# @Date: 2019-06-12 20:28:25
# @Last Modified by: Shuailong
# @Last Modified time: 2019-06-12 20:28:32
...
@DatasetReader.register("csqa-question-evidence-sel")
class CSQAReaderQuestionEvidenceSel(DatasetReader):
    """
        ...
        with open(file_path, 'r') as snli_file:
            ...
            for line in snli_file:
                ...
                for choice in sample["question"]["choices"]:
                    if 'evidence_selected' in choice:
                        evidences_score.append(choice['evidence_selected'])
