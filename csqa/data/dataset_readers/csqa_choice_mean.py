...
# @Date: 2019-06-14 14:57:21
# @Last Modified by: Shuailong
# @Last Modified time: 2019-06-14 14:57:34
...
@DatasetReader.register("csqa-choice-mean")
class CSQAReaderChoiceMean(DatasetReader):
    """
    ...
    def text_to_instance(self,  # type: ignore
        ...
        for i, c_tokens in enumerate(choice_tokens):
            ...
            if choice_evidences and choice_evidences[i]:
                ...
                evidence_tokens_flat = []
            qa_pair_evidence = qa_pair + \
                [Token("[SEP]")] + evidence_tokens_flat
