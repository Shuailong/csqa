...

{
    ...
    "train_data_path": data_root + "/csqa/" + split + "/train_rand_split_evidences_w2v_ranked.jsonl",
    "validation_data_path": data_root + "/csqa/" + split + "/dev_rand_split_evidences_w2v_ranked.jsonl",
