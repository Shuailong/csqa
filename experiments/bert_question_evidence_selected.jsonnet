...
{
    "dataset_reader": {
        "type": "csqa-question-evidence-sel",
        "tokenizer": {
            "type": "word",
            "word_splitter": {
                "type": "bert-basic"
    ...
    "train_data_path": data_root + "/csqa/" + split + "/train_rand_split_evidences_bertlarge_ranked_selected.jsonl",
    "validation_data_path": data_root + "/csqa/" + split + "/dev_rand_split_evidences_bertlarge_ranked_selected.jsonl",
