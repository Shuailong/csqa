...
local train_samples = 5000;
local batch_size_base = 6; // 8g GPU mem required
...

{
    ...
    "train_data_path": data_root + "/csqa/" + split + "/train_rand_split_evidences_bertlarge_ranked_sub_5.jsonl",
