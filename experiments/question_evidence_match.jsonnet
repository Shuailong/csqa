...

{
    ...
    "train_data_path": data_root + "/csqa/" + split + "/train_rand_split_qe.txt",
    "validation_data_path": data_root + "/csqa/" + split + "/dev_rand_split_qe.txt",
